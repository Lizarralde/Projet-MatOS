...
/**
 * Headquarter of the application. Identifie the user. Retrieve his reservation. Make it 
...
public class Terminal {
    ...
    public void start(List<User> users, List<MaterialQuantity> mat) {
        ...
        if (getUser(users)) {
            ...
            System.out.println("You are now identified as " + user.getName()
                    + " " + user.getForname());
            System.out.println("Type your command. If you need help, you can use the command 'help'");
    ...
    private void welcome() {
        ...
        System.out.println("What is your ID ? Type your name followed by your forname.");
    }
